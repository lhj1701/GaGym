import contactReducer, {
  ...
  ContactPage,
  removeContact,
} from "../../provider/modules/contact";
import { createAction, nanoid, PayloadAction } from "@reduxjs/toolkit";
import { ContactItem } from "../../provider/modules/contact";
import { call, put, takeEvery, takeLatest } from "@redux-saga/core/effects";
import api, { ContactItemRequest, ContactItemResponse, ContactPagingResponse,} from "../../api/contact";
...
function* addData(action: PayloadAction<ContactItem>) {
  ...
  //    id: contactItemPayload.id,
      txtName: contactItemPayload.txtName,
      txtContact: contactItemPayload.txtContact,
      txtEmail: contactItemPayload.txtEmail,
    };
